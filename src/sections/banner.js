      ...
      <Container>
        <Box sx={styles.contentWrapper}>
          <Box sx={styles.content}>
            <Heading as="h1">
              Building your audience is growing your business
            </Heading>
            <Text as="p">
              We work with you to design, develop and build a creative and logical experience that maximizes your user satisfaction, and extingiushes those nasty churn rates 
            </Text>
...
const styles = {
  contentWrapper: {
    ...
    gap: [0, 0, 0, 0, 40],
    alignItems: 'center',
    minHeight: [null, null, '100vh', '75vh', '75vh', '100vh'],
