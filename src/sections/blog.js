...
const data = [
  {
    ...
    commentCount: 29,
    link: '#!',
    title: `The Confidence Conundrum`,
  },
  {
    id: 2,
    thumb: thumb2,
    ...
    <Box as="section" id="blog" sx={styles.section} variant="section.blog">
      <Container>
        <SectionHeading
          ...
          description="Find out what makes us a multifaceted digital agency, how we crafted creative solutions that transcend business goals and garner recognition."
        />
...
const styles = {
  ...
  grid: {
    gap: 30,
    display: ['grid', null, null, 'grid', 'grid'],
    gridTemplateColumns: [
      'repeat(1, 1fr)',
      'repeat(1, 1fr)',
      'repeat(2, 1fr)',
